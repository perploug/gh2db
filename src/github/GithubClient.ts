...
type OrganizationSimple = components['schemas']['organization-simple'];
...
export class GithubClient implements IGithubClient {
  ...
  api: {
    ...
    organisation: (org: any) => string;
    rateLimit: () => string;
    repositories: (org: any) => string;
    repository: (org: any, repo: any) => string;
    pullRequests: (owner: any, repo: any, state?: string) => string;
    commits: (owner: any, repo: any) => string;
    issues: (org: any, filter?: string, state?: string) => string;
    issuesForRepo: (org: any, repo: any, state?: string) => string;
    members: (org: any) => string;
    communityProfile: (owner: any, name: any) => string;
    webhooks: (owner: any, name: any) => string;
    branchProtection: (owner: any, name: any, branch?: string) => string;
    externalCollaboratorsForOrg: (org: any) => string;
    collaborators: (org: any, repo: any) => string;
    contributorStatsForRepo: (org: any, repo: any) => string;
    contributorsForRepo: (org: any, repo: any) => string;
  ...
  async getOrgDetails(org): Promise<Organization> {
  ...
  async getRepo(org, repo): Promise<Repository> {
    const response = await this.requestorTemplate.get(
  ...
  async getOrgsForUser(): Promise<OrganizationSimple[]> {
    const response = await this.requestorTemplate.get(
  ...
  async getReposForUser(member): Promise<RepositorySimple[]> {
    const response = await this.requestorTemplate.get(
  ...
  async getRepos(org): Promise<RepositorySimple[]> {
