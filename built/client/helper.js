...
function updateOrCreate(model, where, newItem) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, model.findOne({ where: where })];
                case 1:
                    foundItem = _a.sent();
                    if (!!foundItem) return [3 /*break*/, 3];
                    return [4 /*yield*/, model.create(newItem)];
                case 2:
                    c = _a.sent();
                    return [2 /*return*/, c];
                case 3: 
                // Found an item, update it - for now return the found item,,,
                return [4 /*yield*/, model.update(newItem, { where: where })];
                case 4:
                    // Found an item, update it - for now return the found item,,,
                    _a.sent();
...
function mapArray(val, objmap, externalValues) {
    var arr = Array.isArray(val) ? val : [1].fill(val);
