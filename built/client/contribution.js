...
module.exports = /** @class */ (function (_super) {
    ...
    function Contribution(githubClient, databaseClient) {
        ...
        _this.name = 'Contribution';
        return _this;
    }
    Contribution.prototype.sync = function (force) {
    ...
    Contribution.prototype.getAll = function (orgName, repoName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ghClient.getContributions(orgName, repoName)];
