...
module.exports = /** @class */ (function (_super) {
    ...
    function PullRequest(githubClient, databaseClient) {
        ...
        _this.name = 'PullRequest';
        return _this;
    }
    PullRequest.prototype.sync = function (force) {
    ...
    PullRequest.prototype.getAll = function (orgName, repoName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ghClient.getPullRequests(orgName, repoName)];
