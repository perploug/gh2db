...
module.exports = /** @class */ (function (_super) {
    ...
    function Release(githubClient, databaseClient) {
    ...
    Release.prototype.sync = function (force) {
    ...
    Release.prototype.getAll = function (orgName, repoName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ghClient.getReleases(orgName, repoName)];
