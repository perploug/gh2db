...
module.exports = /** @class */ (function (_super) {
    ...
    function Issue(githubClient, databaseClient) {
    ...
    Issue.prototype.sync = function (force) {
    ...
    Issue.prototype.getAll = function (orgName, logger) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ghClient.getIssues(orgName, logger)];
