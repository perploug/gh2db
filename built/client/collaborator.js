...
module.exports = /** @class */ (function (_super) {
    ...
    function Collaborator(githubClient, databaseClient) {
        ...
        _this.name = 'Collaborator';
        return _this;
    }
    Collaborator.prototype.sync = function (force) {
    ...
    Collaborator.prototype.getAll = function (orgName, repoName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ghClient.getCollaborators(orgName, repoName)];
